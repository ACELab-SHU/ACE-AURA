...
// int Task_nrDemodulate(__v14976i8 inSignal_real, __v14976i8 inSignal_imag, short_struct input_nModulationSymb,
...
int Task_nrDemodulate(__v14976i8 inSignal_real, __v14976i8 inSignal_imag, short_struct input_nModulationSymb,
  ...
  // /*--------------------input Signal--------------------*/
  // __v14976i8 inSignal_real;
  // __v14976i8 inSignal_imag;
  ...
  case 2: {
    ...
    vsetshamt(0);
    __v7488i16 softbit_shuffle_index_tmp;
  ...
  case 4: {
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -d, MASKREAD_ON, rxSignalLength);
    ...
    softbit3 = vsadd(softbit3, -2 * d, MASKREAD_ON, rxSignalLength);
    vsetshamt(fractionLength);
    ...
    softbit4 = vsadd(softbit4, -2 * d, MASKREAD_ON, rxSignalLength);
    vsetshamt(fractionLength);
  ...
  case 6: {
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -3 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -2 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -3 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -2 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsle(inSignal_real, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -5 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -4 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -3 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, -2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsle(inSignal_imag, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -5 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -4 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -3 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, -2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 4 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -2 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, -4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 4 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -2 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, -4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
  ...
  case 8: {
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -7 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -6 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -5 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit1 = vsadd(inSignal_real, -4 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -7 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -6 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -5 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit2 = vsadd(inSignal_imag, -4 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsle(inSignal_real, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -11 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -4 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 12 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -10 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -3 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 12 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 10 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -9 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 10 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 6 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -8 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -7 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 4 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit3 = vsadd(inSignal_real, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit3 = vmul(softbit3, -3 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsle(inSignal_imag, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -11 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -4 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 12 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -10 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -3 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 12 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 10 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -9 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 10 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 6 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -8 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -7 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 4 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit4 = vsadd(inSignal_imag, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit4 = vmul(softbit4, -3 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsle(inSignal_real, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -13 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 10 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -12 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 10 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 8 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -11 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 8 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 6 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -5 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, 2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -4 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit5 = vsadd(inSignal_real, -3 * d, MASKREAD_ON, rxSignalLength);
    softbit5 = vmul(softbit5, 2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, -2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsle(inSignal_imag, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -13 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 14 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 10 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -12 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 10 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 8 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -11 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, -2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 8 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 6 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -5 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, 2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 6 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -4 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 2 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit6 = vsadd(inSignal_imag, -3 * d, MASKREAD_ON, rxSignalLength);
    softbit6 = vmul(softbit6, 2 * factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_imag, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_imag, -2 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit7 = vsadd(inSignal_real, -14 * d, MASKREAD_ON, rxSignalLength);
    softbit7 = vmul(softbit7, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 12 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 8 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit7 = vsadd(inSignal_real, -10 * d, MASKREAD_ON, rxSignalLength);
    softbit7 = vmul(softbit7, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 8 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit7 = vsadd(inSignal_real, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit7 = vmul(softbit7, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 4 * d, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit7 = vsadd(inSignal_real, -2 * d, MASKREAD_ON, rxSignalLength);
    softbit7 = vmul(softbit7, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    vsgt(inSignal_real, 0, MASKREAD_OFF, MASKWRITE_ON, rxSignalLength);
    vsle(inSignal_real, -4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    ...
    vsetshamt(fractionLength);
    softbit8 = vsadd(inSignal_imag, -14 * d, MASKREAD_ON, rxSignalLength);
    ...
    vsle(inSignal_imag, 8 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit8 = vsadd(inSignal_imag, -10 * d, MASKREAD_ON, rxSignalLength);
    softbit8 = vmul(softbit8, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    ...
    vsle(inSignal_imag, 4 * d, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit8 = vsadd(inSignal_imag, -6 * d, MASKREAD_ON, rxSignalLength);
    softbit8 = vmul(softbit8, -factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
    ...
    vsle(inSignal_imag, 0, MASKREAD_ON, MASKWRITE_ON, rxSignalLength);
    vsetshamt(fractionLength);
    softbit8 = vsadd(inSignal_imag, -2 * d, MASKREAD_ON, rxSignalLength);
    softbit8 = vmul(softbit8, factor, MASKREAD_ON, rxSignalLength);
    vsetshamt(0);
  ...
  vreturn(softbit, rxSignalLength * nModulationSymb, &demod_length, sizeof(demod_length));
