...
// int Task_nrPhaseDeCompensation(__v4096i8 OFDM_OutReal, __v4096i8 OFDM_OutImag, __v4096i8 Phase_cos, __v4096i8
// Phase_sin,
//                                short_struct subCarrierSpace, short_struct symbolNum, short_struct NRB) {
int Task_nrPhaseDeCompensation(__v4096i8 OFDM_OutReal, __v4096i8 OFDM_OutImag, char_struct Phase_cos_in,
                               char_struct Phase_sin_in, short_struct subCarrierSpace, short_struct symbolNum,
                               short_struct NRB) {

  // input parameter
  char  Phase_cos  = Phase_cos_in.data;
  char  Phase_sin  = Phase_sin_in.data;
