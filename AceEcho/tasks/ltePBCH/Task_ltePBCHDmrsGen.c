 ...
 */
 ...
 int Task_ltePBCHDmrsGen(
     ...
     __v2048i16 seq2_trans_table_0_vec, __v2048i16 seq2_trans_table_1_vec, __v2048i16 seq2_trans_table_2_vec,
     __v2048i16 seq2_trans_table_3_vec, __v2048i16 seq2_trans_table_4_vec, __v2048i16 seq2_trans_table_5_vec,
     __v2048i16 seq2_trans_table_6_vec, short_struct nCellID, short_struct slot_num, short_struct symbol_num)
 {
  ...
  // printf("%d",&init2);
   ...
   seq = nrPRBS(seq1_vec, init2_vec, seq2_init_table_0_vec, seq2_init_table_1_vec, seq2_init_table_2_vec,
    ...
    vrange(dmrs_shuffle_index, 12);
    dmrs_shuffle_index = vmul(dmrs_shuffle_index, 2, MASKREAD_OFF, 12);
    dmrs_shuffle_index = vadd(dmrs_shuffle_index,208,MASKREAD_OFF,12);
    __v4096i8 dmrs_real;
    vclaim(dmrs_real);
    vshuffle(dmrs_real, dmrs_shuffle_index, seq, SHUFFLE_GATHER, 12);
    dmrs_real          = vmul(dmrs_real, (int)(recpSqrt2 * (1 << fractionLength)), MASKREAD_OFF, 12);
    dmrs_shuffle_index = vsadd(dmrs_shuffle_index, 1, MASKREAD_OFF, 12);
    __v4096i8 dmrs_imag;
    vclaim(dmrs_imag);
    vshuffle(dmrs_imag, dmrs_shuffle_index, seq, SHUFFLE_GATHER, 12);
    dmrs_imag = vmul(dmrs_imag, (int)(recpSqrt2 * (1 << fractionLength)), MASKREAD_OFF, 12);
  
    vreturn(dmrs_real, 12, dmrs_imag, 12);
